(function(e, t) {
    ...
    (function(r) {
        ...
        function m(e, t) {
            ...
            if (e && e.charAt(0) === ".") if (t) {
                e = e.split("/"), o = e.length - 1, l.nodeIdCompat && d.test(e[o]) && (e[o] = e[o].replace(d, "")), 
        ...
        o = function(e, t) {
            var n, r = E(e), i = r[0];
            return e = r[1], i && (i = m(i, t), n = w(i)), i ? n && n.normalize ? e = n.normalize(e, y(t)) : e = m(e, t) : (e = m(e, t), 
            r = E(e), i = r[0], e = r[1], i && (n = w(i))), {
                f: i ? i + "!" + e : e,
                n: e,
                pr: i,
                p: n
            ...
            if (y === "undefined" || y === "function") {
                ...
                for (d = 0; d < t.length; d += 1) {
                    p = o(t[d], i), l = p.f;
                    if (l === "require") m[d] = u.require(e); else if (l === "exports") m[d] = u.exports(e), 
                    E = !0; else if (l === "module") s = m[d] = u.module(e); else if (v(a, l) || v(f, l) || v(c, l)) m[d] = w(l); else {
    ...
    return !function() {
        function e() {
            T = !0, clearTimeout(N), N = setTimeout(function() {
                T = !1;
            }, 700);
        }
        function t(e, t) {
        ...
        function n(e, n, r) {
            for (var i = t(e, n), s = e, o = []; s && s !== i; ) v(s, "pointerenter") && o.push(s), 
            s = s.parentNode;
        ...
        function i(e, t) {
            [ "pointerdown", "pointermove", "pointerup", "pointerover", "pointerout" ].forEach(function(n) {
                ...
                if (!T) {
                    ...
                    r && r !== window && (r.contains(e.relatedTarget) || n(r, e.relatedTarget, function(n) {
                ...
                if (!T) {
                    ...
                    n && n !== window && (n.contains(e.relatedTarget) || r(n, e.relatedTarget, function(n) {
        ...
        if (!window.PointerEvent) {
            ...
            var s = [ "pointerdown", "pointerup", "pointermove", "pointerover", "pointerout", "pointercancel", "pointerenter", "pointerleave" ], o = [ "PointerDown", "PointerUp", "PointerMove", "PointerOver", "PointerOut", "PointerCancel", "PointerEnter", "PointerLeave" ], u = "touch", a = "pen", f = "mouse", l = {}, c = function(e) {
                for (;e && !e.handjs_forcePreventDefault; ) e = e.parentNode;
                return !!e || window.handjs_forcePreventDefault;
            }, h = function(e, t, n, r, i) {
                var s;
                if (document.createEvent ? (s = document.createEvent("MouseEvents"), s.initMouseEvent(t, n, !0, window, 1, e.screenX, e.screenY, e.clientX, e.clientY, e.ctrlKey, e.altKey, e.shiftKey, e.metaKey, e.button, i || e.relatedTarget)) : (s = document.createEventObject(), 
                s.screenX = e.screenX, s.screenY = e.screenY, s.clientX = e.clientX, s.clientY = e.clientY, 
                s.ctrlKey = e.ctrlKey, s.altKey = e.altKey, s.shiftKey = e.shiftKey, s.metaKey = e.metaKey, 
                s.button = e.button, s.relatedTarget = i || e.relatedTarget), void 0 === s.offsetX && (void 0 !== e.offsetX ? (Object && void 0 !== Object.defineProperty && (Object.defineProperty(s, "offsetX", {
                    writable: !0
                }), Object.defineProperty(s, "offsetY", {
                    writable: !0
                })), s.offsetX = e.offsetX, s.offsetY = e.offsetY) : Object && void 0 !== Object.defineProperty ? (Object.defineProperty(s, "offsetX", {
                    get: function() {
                ...
                })) : void 0 !== e.layerX && (s.offsetX = e.layerX - e.currentTarget.offsetLeft, 
                s.offsetY = e.layerY - e.currentTarget.offsetTop)), s.isPrimary = void 0 !== e.isPrimary ? e.isPrimary : !0, 
                e.pressure) s.pressure = e.pressure; else {
                    var o = 0;
                    void 0 !== e.which ? o = e.which : void 0 !== e.button && (o = e.button), s.pressure = 0 === o ? 0 : .5;
                }
                if (s.rotation = e.rotation ? e.rotation : 0, s.hwTimestamp = e.hwTimestamp ? e.hwTimestamp : 0, 
                s.tiltX = e.tiltX ? e.tiltX : 0, s.tiltY = e.tiltY ? e.tiltY : 0, s.height = e.height ? e.height : 0, 
                s.width = e.width ? e.width : 0, s.preventDefault = function() {
                ...
                t.pointerId = o, t.pointerType = u, t.currentTarget = n, void 0 !== r.preventDefault && (t.preventDefault = function() {
                    r.preventDefault();
                }), h(t, e, i, n, s);
            }, v = function(e, t) {
                ...
                var n = s.indexOf(t), r = e + o[n];
                return r;
            }, w = function(e, t, n, r) {
                if (void 0 === e.__handjsRegisteredEvents && (e.__handjsRegisteredEvents = []), 
                r) {
                    if (void 0 !== e.__handjsRegisteredEvents[t]) return e.__handjsRegisteredEvents[t]++, 
                    void 0;
                    e.__handjsRegisteredEvents[t] = 1, e.addEventListener(t, n, !1);
                } else {
                    if (-1 !== e.__handjsRegisteredEvents.indexOf(t) && (e.__handjsRegisteredEvents[t]--, 
                    0 !== e.__handjsRegisteredEvents[t])) return;
                    e.removeEventListener(t, n), e.__handjsRegisteredEvents[t] = 0;
                }
            }, E = function(e, t, n) {
                if (e.__handjsGlobalRegisteredEvents || (e.__handjsGlobalRegisteredEvents = []), 
                n) {
                    if (void 0 !== e.__handjsGlobalRegisteredEvents[t]) return e.__handjsGlobalRegisteredEvents[t]++, 
                    void 0;
                    e.__handjsGlobalRegisteredEvents[t] = 1;
                } else void 0 !== e.__handjsGlobalRegisteredEvents[t] && (e.__handjsGlobalRegisteredEvents[t]--, 
                e.__handjsGlobalRegisteredEvents[t] < 0 && (e.__handjsGlobalRegisteredEvents[t] = 0));
                var r, i;
                switch (window.MSPointerEvent ? (r = function(e) {
                    return b("MS", e);
                }, i = h) : (r = y, i = p), t) {
                  case "pointerenter":
                  case "pointerleave":
                    var s = r(t);
                    void 0 !== e["on" + s.toLowerCase()] && w(e, s, function(e) {
                        i(e, t);
                    }, n);
                }
            }, S = function(e) {
                var t = e.prototype ? e.prototype.addEventListener : e.addEventListener, n = function(e, n, r) {
                ...
                var t = e.prototype ? e.prototype.removeEventListener : e.removeEventListener, n = function(e, n, r) {
            ...
            S(window), S(window.HTMLElement || window.Element), S(document), navigator.isCocoonJS || (S(HTMLBodyElement), 
            S(HTMLDivElement), S(HTMLImageElement), S(HTMLUListElement), S(HTMLAnchorElement), 
            S(HTMLLIElement), S(HTMLTableElement), window.HTMLSpanElement && S(HTMLSpanElement)), 
            window.HTMLCanvasElement && S(HTMLCanvasElement), !navigator.isCocoonJS && window.SVGElement && S(SVGElement), 
            x(window), x(window.HTMLElement || window.Element), x(document), navigator.isCocoonJS || (x(HTMLBodyElement), 
            x(HTMLDivElement), x(HTMLImageElement), x(HTMLUListElement), x(HTMLAnchorElement), 
            x(HTMLLIElement), x(HTMLTableElement), window.HTMLSpanElement && x(HTMLSpanElement)), 
            window.HTMLCanvasElement && x(HTMLCanvasElement), !navigator.isCocoonJS && window.SVGElement && x(SVGElement);
            var T = !1, N = -1;
            !function() {
                window.MSPointerEvent ? i(function(e) {
                    return b("MS", e);
                }, h) : (i(y, p), void 0 !== window.ontouchstart && (window.addEventListener("touchstart", function(t) {
                    for (var r = 0; r < t.changedTouches.length; ++r) {
                        var i = t.changedTouches[r];
                        l[i.identifier] = i.target, g("pointerover", i, i.target, t, !0), n(i.target, null, function(e) {
                    ...
                    for (var n = 0; n < t.changedTouches.length; ++n) {
                        var i = t.changedTouches[n], s = l[i.identifier];
                        g("pointerup", i, s, t, !0), g("pointerout", i, s, t, !0), r(s, null, function(e) {
                    ...
                    for (var i = 0; i < t.changedTouches.length; ++i) {
                        var s = t.changedTouches[i], o = document.elementFromPoint(s.clientX, s.clientY), u = l[s.identifier];
                        if (u && c(u) === !0 && t.preventDefault(), g("pointermove", s, u, t, !0), !navigator.isCocoonJS) {
                            ...
                            if (u === o) continue;
                            u && (g("pointerout", s, u, t, !0, o), u.contains(o) || r(u, o, function(e) {
                                d("pointerleave", s, e, t, !1, o);
                            })), o && (g("pointerover", s, o, t, !0, u), o.contains(u) || n(o, u, function(e) {
        ...
        window.PointerEvent || document.styleSheets && document.addEventListener && document.addEventListener("DOMContentLoaded", function() {
            if (void 0 === document.body.style.touchAction) {
                var e = new RegExp(".+?{.*?}", "m"), t = new RegExp(".+?{", "m"), n = function(n) {
                    var r = e.exec(n);
                    if (r) {
                        var i = r[0];
                        n = n.replace(i, "").trim();
                        var s = t.exec(i)[0].replace("{", "").trim();
                        if (-1 !== i.replace(/\s/g, "").indexOf("touch-action:none")) for (var o = document.querySelectorAll(s), u = 0; u < o.length; u++) {
                            var a = o[u];
                    ...
                    if (window.setImmediate) e && setImmediate(r, n(e)); else for (;e; ) e = n(e);
                };
                try {
                ...
                for (var f = document.getElementsByTagName("style"), i = 0; i < f.length; i++) {
                    var l = f[i], c = l.innerHTML.replace(/(\n|\r)/g, "").trim();
                    r(c);
                }
            }
        }, !1);
    }(), n("../node_modules/handjs/hand.min", function() {}), function(e) {
        n("p", [], function() {
            return function() {
                return function n(e, r, i) {
                    ...
                    1: [ function(e, t, n) {
                        (function(n, r, i, s, o, u, a, f, l) {
                            var c = e("./js/protoplast"), h = e("./js/aop"), p = e("./js/dispatcher"), d = e("./js/di"), v = e("./js/component"), m = e("./js/utils"), g = e("./js/constructors"), y = {
                                extend: c.extend.bind(c),
                                create: c.create.bind(c),
                                Dispatcher: p,
                                Aop: h,
                                Context: d,
                                Component: v,
                        ...
                        (function(n, r, i, s, o, u, a, f, l) {
                            var c = e("./protoplast"), h = c.extend({
                                ...
                                __fastinject__: {
                                    ...
                                    set: function(e) {
                                        this.___fastinject___ = e, this._children.forEach(function(e) {
                    ...
                    5: [ function(e, t, n) {
                        (function(n, r, i, s, o, u, a, f, l) {
                            var c = e("./protoplast"), h = e("./dispatcher"), p = c.extend({
                                $create: function() {
                                    var e = this;
                                    this._objects = {
                                        pub: function(t, n) {
                                    ...
                                    }, this._unknows = [], this._dispatcher = h.create();
                                },
                                _objects: null,
                                register: function(e, t) {
                                    arguments.length == 1 ? (t = e, this._unknows.push(t)) : this._objects[e] = t, t.__fastinject__ = function(e) {
                                        this.register(e), this.process(e);
                                    }.bind(this), t.$meta && t.$meta.inject && this.inject(t, t.$meta.inject);
                                },
                                process: function(e) {
                                    e.$meta && e.$meta.inject_init && Object.keys(e.$meta.inject_init).forEach(function(t) {
                                        e[t]();
                                    }, this), e.$meta && e.$meta.sub && Object.keys(e.$meta.sub).forEach(function(t) {
                                        this._objects.sub.call(e, e.$meta.sub[t]).add(e[t]);
                                    }, this);
                                },
                                inject: function(e, t) {
                                    var n = this, r;
                                    for (var i in t) t.hasOwnProperty(i) && (r = t[i], function(t) {
                                ...
                                build: function() {
                                    Object.keys(this._objects).forEach(function(e) {
                                        ...
                                        this.process(t);
                                    }, this), this._unknows.forEach(function(e) {
                                        this.process(e);
                                    }, this);
                                }
                            });
                        ...
                        (function(n, r, i, s, o, u, a, f, l) {
                            var c = e("./protoplast"), h = c.extend({
                                dispatch: function(e, t) {
                                    this._topics = this._topics || {}, (this._topics[e] || []).forEach(function(e) {
                                        e.handler.call(e.context, t);
                                    });
                                },
                                on: function(e, t, n) {
                                    if (!t) throw new Error("Handler is required for event " + e);
                                    this._topics = this._topics || {}, this._topics[e] = this._topics[e] || [], this._topics[e].push({
                                        handler: t,
                                        context: n
                                    });
                                },
                                off: function(e, t, n) {
                                    this._topics = this._topics || {}, this._topics[e] = this._topics[e].filter(function(e) {
                    ...
                    7: [ function(e, t, n) {
                        (function(n, r, i, s, o, u, a, f, l) {
                            ...
                            h.extend = function(e, t) {
                                var n = Object.create(this), r, i, s;
                                e instanceof Array || (t = e, e = []), t = t || {}, e = e || [], r = t.$meta || {}, 
                                delete t.$meta, t.$create !== undefined && (r.$constructors = r.$constructors || [], 
                                r.$constructors.push(t.$create), delete t.$create), n = c.mixin(n, e);
                                for (var o in t) {
                                    s = !1;
                                    if (Object.prototype.toString.call(t[o]) !== "[object Object]") s = !0, i = {
                                        value: t[o],
                                        writable: !0,
                                        enumerable: !0
                                    }; else {
                                        i = t[o];
                                        for (var u in i) [ "value", "get", "set", "writable", "enumerable" ].indexOf(u) === -1 ? (r[u] = r[u] || {}, 
                                        r[u][o] = i[u], delete i[u]) : s = !0;
                                    }
                                    s && Object.defineProperty(n, o, i);
                                }
                                return n.$meta = c.merge(r, this.$meta), n.$super = this, c.processPrototype(n), 
                                n;
                            }, t.exports = h;
                    ...
                    8: [ function(e, t, n) {
                        (function(e, n, r, i, s, o, u, a, f) {
                            ...
                            function h(e, t) {
                                ...
                                return n.$meta.$constructors && n.$meta.$constructors.forEach(function(e) {
                                    e.apply(n, t);
                                }), n;
                            }
                            function p(e) {
                                e.$meta.$processors && e.$meta.$processors.forEach(function(t) {
                                    t(e);
                                });
                            }
                            function d(e, t) {
                                for (var n in t) t.hasOwnProperty(n) && (t[n] instanceof Array ? e[n] = t[n].concat(e[n] || []) : [ "number", "boolean", "string" ].indexOf(typeof t[n]) !== -1 ? e.hasOwnProperty(n) || (e[n] = t[n]) : (e[n] = e[n] || {}, 
                                d(e[n], t[n])));
                                return e;
                            }
                            function v(e, t) {
                        ...
                        (function(t, r, i, s, o, u, a, f, l) {
                            function i(e, t, n) {
                                if (this instanceof i) {
                                    ...
                                    var s;
                                    if (r === "number") s = q(e); else if (r === "string") s = i.byteLength(e, t); else {
                                        if (r !== "object") throw new Error("First argument needs to be a number, array or string.");
                                        s = q(e.length);
                                    }
                                    var o;
                                    i._useTypedArrays ? o = i._augment(new Uint8Array(s)) : (o = this, o.length = s, 
                                    o._isBuffer = !0);
                                    var u;
                                    if (i._useTypedArrays && typeof e.byteLength == "number") o._set(e); else if (U(e)) for (u = 0; u < s; u++) i.isBuffer(e) ? o[u] = e.readUInt8(u) : o[u] = e[u]; else if (r === "string") o.write(e, 0, t); else if (r === "number" && !i._useTypedArrays && !n) for (u = 0; u < s; u++) o[u] = 0;
                                    return o;
                                }
                                return new i(e, t, n);
                            }
                            ...
                            function w(e, t, n) {
                                ...
                                for (var s = t; s < n; s++) e[s] <= 127 ? (r += K(i) + String.fromCharCode(e[s]), 
                                i = "") : i += "%" + e[s].toString(16);
                                return r + K(i);
                            }
                            function E(e, t, n) {
                            ...
                            function N(e, t, n, r) {
                                r || (Z(typeof n == "boolean", "missing or invalid endian"), Z(t !== undefined && t !== null, "missing offset"), 
                                Z(t + 1 < e.length, "Trying to read beyond buffer length"));
                                var i = e.length;
                                if (t >= i) return;
                                var s;
                                return n ? (s = e[t], t + 1 < i && (s |= e[t + 1] << 8)) : (s = e[t] << 8, t + 1 < i && (s |= e[t + 1])), 
                                s;
                            }
                            function C(e, t, n, r) {
                                r || (Z(typeof n == "boolean", "missing or invalid endian"), Z(t !== undefined && t !== null, "missing offset"), 
                                Z(t + 3 < e.length, "Trying to read beyond buffer length"));
                                var i = e.length;
                                if (t >= i) return;
                                var s;
                                return n ? (t + 2 < i && (s = e[t + 2] << 16), t + 1 < i && (s |= e[t + 1] << 8), 
                                s |= e[t], t + 3 < i && (s += e[t + 3] << 24 >>> 0)) : (t + 1 < i && (s = e[t + 1] << 16), 
                                t + 2 < i && (s |= e[t + 2] << 8), t + 3 < i && (s |= e[t + 3]), s += e[t] << 24 >>> 0), 
                                s;
                            }
                            function k(e, t, n, r) {
                                r || (Z(typeof n == "boolean", "missing or invalid endian"), Z(t !== undefined && t !== null, "missing offset"), 
                            ...
                            function L(e, t, n, r) {
                                ...
                                var i = e.length;
                                if (t >= i) return;
                                var s = C(e, t, n, !0), o = s & 2147483648;
                                return o ? (4294967295 - s + 1) * -1 : s;
                            }
                            function A(e, t, n, r) {
                                return r || (Z(typeof n == "boolean", "missing or invalid endian"), Z(t + 3 < e.length, "Trying to read beyond buffer length")), 
                                h.read(e, t, n, 23, 4);
                            }
                            function O(e, t, n, r) {
                                return r || (Z(typeof n == "boolean", "missing or invalid endian"), Z(t + 7 < e.length, "Trying to read beyond buffer length")), 
                                h.read(e, t, n, 52, 8);
                            }
                            function M(e, t, n, r, i) {
                                i || (Z(t !== undefined && t !== null, "missing value"), Z(typeof r == "boolean", "missing or invalid endian"), 
                                Z(n !== undefined && n !== null, "missing offset"), Z(n + 1 < e.length, "trying to write beyond buffer length"), 
                                Q(t, 65535));
                                var s = e.length;
                                if (n >= s) return;
                            ...
                            function _(e, t, n, r, i) {
                                i || (Z(t !== undefined && t !== null, "missing value"), Z(typeof r == "boolean", "missing or invalid endian"), 
                                Z(n !== undefined && n !== null, "missing offset"), Z(n + 3 < e.length, "trying to write beyond buffer length"), 
                                Q(t, 4294967295));
                                var s = e.length;
                                if (n >= s) return;
                            ...
                            function H(e, t, n, r, i) {
                                i || (Z(t !== undefined && t !== null, "missing value"), Z(typeof r == "boolean", "missing or invalid endian"), 
                                Z(n !== undefined && n !== null, "missing offset"), Z(n + 3 < e.length, "Trying to write beyond buffer length"), 
                                Y(t, 3.4028234663852886e38, -3.4028234663852886e38));
                                var s = e.length;
                                if (n >= s) return;
                            ...
                            function B(e, t, n, r, i) {
                                i || (Z(t !== undefined && t !== null, "missing value"), Z(typeof r == "boolean", "missing or invalid endian"), 
                                Z(n !== undefined && n !== null, "missing offset"), Z(n + 7 < e.length, "Trying to write beyond buffer length"), 
                                Y(t, 1.7976931348623157e308, -1.7976931348623157e308));
                                var s = e.length;
                                if (n >= s) return;
                            ...
                            function W(e) {
                                ...
                                for (var n = 0; n < e.length; n++) {
                                    ...
                                    if (r <= 127) t.push(e.charCodeAt(n)); else {
                                        var i = n;
                                        r >= 55296 && r <= 57343 && n++;
                                        var s = encodeURIComponent(e.slice(i, n + 1)).substr(1).split("%");
                            ...
                            function V(e) {
                                var t, n, r, i = [];
                                for (var s = 0; s < e.length; s++) t = e.charCodeAt(s), n = t >> 8, r = t % 256, 
                                i.push(r), i.push(n);
                                return i;
                            }
                            function $(e) {
                            ...
                            function Q(e, t) {
                                Z(typeof e == "number", "cannot write a non-number as a number"), Z(e >= 0, "specified a negative value for writing an unsigned value"), 
                                Z(e <= t, "value is larger than maximum value for type"), Z(Math.floor(e) === e, "value has a fractional component");
                            }
                            function G(e, t, n) {
                                Z(typeof e == "number", "cannot write a non-number as a number"), Z(e <= t, "value larger than maximum allowed value"), 
                                Z(e >= n, "value smaller than minimum allowed value"), Z(Math.floor(e) === e, "value has a fractional component");
                            }
                            function Y(e, t, n) {
                                Z(typeof e == "number", "cannot write a non-number as a number"), Z(e <= t, "value larger than maximum allowed value"), 
                                Z(e >= n, "value smaller than minimum allowed value");
                            }
                            function Z(e, t) {
                                if (!e) throw new Error(t || "Failed assertion");
                            }
                            var c = e("base64-js"), h = e("ieee754");
                            n.Buffer = i, n.SlowBuffer = i, n.INSPECT_MAX_BYTES = 50, i.poolSize = 8192, i._useTypedArrays = function() {
                                ...
                                Z(r >= n, "sourceEnd < sourceStart"), Z(t >= 0 && t < e.length, "targetStart out of bounds"), 
                                Z(n >= 0 && n < s.length, "sourceStart out of bounds"), Z(r >= 0 && r <= s.length, "sourceEnd out of bounds"), 
                                r > this.length && (r = this.length), e.length - t < r - n && (r = e.length - t + n);
                                var o = r - n;
                                if (o < 100 || !i._useTypedArrays) for (var u = 0; u < o; u++) e[u + t] = this[u + n]; else e._set(this.subarray(n, n + o), t);
                            }, i.prototype.slice = function(e, t) {
                                var n = this.length;
                                e = I(e, n, 0), t = I(t, n, n);
                                if (i._useTypedArrays) return i._augment(this.subarray(e, t));
                                var r = t - e, s = new i(r, undefined, !0);
                                ...
                                n || (Z(e !== undefined && e !== null, "missing value"), Z(t !== undefined && t !== null, "missing offset"), 
                                Z(t < this.length, "trying to write beyond buffer length"), Q(e, 255));
                                ...
                                n || (Z(e !== undefined && e !== null, "missing value"), Z(t !== undefined && t !== null, "missing offset"), 
                                Z(t < this.length, "Trying to write beyond buffer length"), G(e, 127, -128));
                                if (t >= this.length) return;
                                ...
                                Z(typeof e == "number" && !isNaN(e), "value is not a number"), Z(n >= t, "end < start");
                                if (n === t) return;
                            ...
                            i._augment = function(e) {
                                return e._isBuffer = !0, e._get = e.get, e._set = e.set, e.get = F.get, e.set = F.set, 
                                e.write = F.write, e.toString = F.toString, e.toLocaleString = F.toString, e.toJSON = F.toJSON, 
                                e.copy = F.copy, e.slice = F.slice, e.readUInt8 = F.readUInt8, e.readUInt16LE = F.readUInt16LE, 
                                e.readUInt16BE = F.readUInt16BE, e.readUInt32LE = F.readUInt32LE, e.readUInt32BE = F.readUInt32BE, 
                                e.readInt8 = F.readInt8, e.readInt16LE = F.readInt16LE, e.readInt16BE = F.readInt16BE, 
                                e.readInt32LE = F.readInt32LE, e.readInt32BE = F.readInt32BE, e.readFloatLE = F.readFloatLE, 
                                e.readFloatBE = F.readFloatBE, e.readDoubleLE = F.readDoubleLE, e.readDoubleBE = F.readDoubleBE, 
                                e.writeUInt8 = F.writeUInt8, e.writeUInt16LE = F.writeUInt16LE, e.writeUInt16BE = F.writeUInt16BE, 
                                e.writeUInt32LE = F.writeUInt32LE, e.writeUInt32BE = F.writeUInt32BE, e.writeInt8 = F.writeInt8, 
                                e.writeInt16LE = F.writeInt16LE, e.writeInt16BE = F.writeInt16BE, e.writeInt32LE = F.writeInt32LE, 
                                e.writeInt32BE = F.writeInt32BE, e.writeFloatLE = F.writeFloatLE, e.writeFloatBE = F.writeFloatBE, 
                                e.writeDoubleLE = F.writeDoubleLE, e.writeDoubleBE = F.writeDoubleBE, e.fill = F.fill, 
                                e.inspect = F.inspect, e.toArrayBuffer = F.toArrayBuffer, e;
                            };
                        ...
                        (function(e, t, r, i, s, o, u, a, f) {
                            ...
                            (function(e) {
                                ...
                                function c(e) {
                                    ...
                                    var a = e.length;
                                    o = "=" === e.charAt(a - 2) ? 2 : "=" === e.charAt(a - 1) ? 1 : 0, u = new t(e.length * 3 / 4 - o), 
                                    i = o > 0 ? e.length - 4 : e.length;
                                    var l = 0;
                                    for (n = 0, r = 0; n < i; n += 4, r += 3) s = f(e.charAt(n)) << 18 | f(e.charAt(n + 1)) << 12 | f(e.charAt(n + 2)) << 6 | f(e.charAt(n + 3)), 
                                    c((s & 16711680) >> 16), c((s & 65280) >> 8), c(s & 255);
                                    return o === 2 ? (s = f(e.charAt(n)) << 2 | f(e.charAt(n + 1)) >> 4, c(s & 255)) : o === 1 && (s = f(e.charAt(n)) << 10 | f(e.charAt(n + 1)) << 4 | f(e.charAt(n + 2)) >> 2, 
                                    c(s >> 8 & 255), c(s & 255)), u;
                                }
                                function h(e) {
                                    function o(e) {
                                    ...
                                    var t, n = e.length % 3, r = "", i, s;
                                    for (t = 0, s = e.length - n; t < s; t += 3) i = (e[t] << 16) + (e[t + 1] << 8) + e[t + 2], 
                                    r += u(i);
                                    switch (n) {
                                      case 1:
                                      ...
                                      case 2:
                                        i = (e[e.length - 2] << 8) + e[e.length - 1], r += o(i >> 10), r += o(i >> 4 & 63), 
                                        r += o(i << 2 & 63), r += "=";
                                    }
                                    return r;
                                }
                                var t = typeof Uint8Array != "undefined" ? Uint8Array : Array, n = "+".charCodeAt(0), r = "/".charCodeAt(0), i = "0".charCodeAt(0), s = "a".charCodeAt(0), o = "A".charCodeAt(0), u = "-".charCodeAt(0), a = "_".charCodeAt(0);
                    ...
                    11: [ function(e, t, n) {
                        (function(e, t, r, i, s, o, u, a, f) {
                            n.read = function(e, t, n, r, i) {
                                var s, o, u = i * 8 - r - 1, a = (1 << u) - 1, f = a >> 1, l = -7, c = n ? i - 1 : 0, h = n ? -1 : 1, p = e[t + c];
                                ...
                                var o, u, a, f = s * 8 - i - 1, l = (1 << f) - 1, c = l >> 1, h = i === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, p = r ? 0 : s - 1, d = r ? 1 : -1, v = t < 0 || t === 0 && 1 / t < 0 ? 1 : 0;
                                t = Math.abs(t), isNaN(t) || t === Infinity ? (u = isNaN(t) ? 1 : 0, o = l) : (o = Math.floor(Math.log(t) / Math.LN2), 
                                t * (a = Math.pow(2, -o)) < 1 && (o--, a *= 2), o + c >= 1 ? t += h / a : t += h * Math.pow(2, 1 - c), 
                                t * a >= 2 && (o++, a /= 2), o + c >= l ? (u = 0, o = l) : o + c >= 1 ? (u = (t * a - 1) * Math.pow(2, i), 
                                o += c) : (u = t * Math.pow(2, c - 1) * Math.pow(2, i), o = 0));
                    ...
                    12: [ function(e, t, n) {
                        (function(e, n, r, i, s, o, u, a, f) {
                            ...
                            }(), e.title = "browser", e.browser = !0, e.env = {}, e.argv = [], e.on = l, e.addListener = l, 
                            e.once = l, e.off = l, e.removeListener = l, e.removeAllListeners = l, e.emit = l, 
                ...
                }, {}, [ 1 ]), e.Protoplast = Protoplast;
            }.apply(e, arguments);
        });
    }(this), n("model/recognition-data", [ "require", "p" ], function(e) {
        var t = e("p"), n = t.extend({
            allMatches: null,
            bestMatch: null,
            $create: function(e) {
                this.allMatches = e, this.bestMatch = null, e.forEach(function(e) {
        ...
        var t = e("p"), n = e("model/recognition-data"), r = t.extend([ t.Dispatcher ], {
            _sampler: null,
            patterns: null,
            sampler: {
                set: function(e) {
        ...
        var t = e("p"), n = t.extend({
            ...
            threePointsAngle: function(e, t, n) {
                var r = e.subtract(t), i = n.subtract(t), s = r.x * i.x + r.y * i.y, o = s / (r.length * i.length);
                return Math.acos(o);
            }
        });
        return n;
    }), n("model/point", [ "require", "p", "util/math" ], function(e) {
        var t = e("p"), n = e("util/math"), r = t.extend({
            x: null,
            y: null,
            $create: function(e, t) {
                this.x = e, this.y = t;
        ...
        var t = e("p"), n = e("model/directions"), r = e("model/point"), i = t.extend({
            twoPointsDirection: function(e, t) {
                var i = t.subtract(e);
                if (e.x === t.x && e.y === t.y) return 0;
                var s = r.create(0, -1), o = i.x * s.x + i.y * s.y, u = o / (i.length * s.length), a = this._eight(Math.acos(u));
                if (i.x < 0) switch (a) {
                  case 0:
                    return n.UP;
        ...
        var t = e("p"), n = t.extend({
            ...
            _mosesFit: function(e, t) {
                var n;
                e.length >= t.length ? (n = (e.length - 1) / (t.length - 1), this._reducedPatternData = this._reduceList(e, n == Infinity ? n = t.length : n), 
                this._reducedSamplingData = t) : (n = (t.length - 1) / (e.length - 1), this._reducedPatternData = e, 
                this._reducedSamplingData = this._reduceList(t, n == Infinity ? n = e.length : n));
            },
        ...
        var t = e("p"), n = e("util/direction"), r = e("algorithm/moses-fit"), i = e("model/match"), s = t.extend({
            _threshold: null,
            _minSamplerPoints: null,
            $create: function(e, t) {
                this._threshold = e || .5, this._minSamplerPoints = t || 5;
            },
            match: function(e, t) {
                var n = this._matchingValue(e.data, t), r = n >= this._threshold && t.length >= this._minSamplerPoints;
                return i.create(e, n, r);
            },
            _matchingValue: function(e, t) {
                var n = r.create(e.slice(), t.slice()), i = this._preparePatternData(n.getReducedPatternData()), s = this._prepareSamplingData(n.getReducedSamplingData()), o = this._pointsToDirections(i), u = this._pointsToDirections(s), a = this._calculateMosesSimilarity(o, u);
                return a;
            },
        ...
        var t = e("p"), n = e("util/direction"), r = t.extend({
            $create: function(e, t) {
        ...
        var t = e("p"), n = e("model/segment"), r = t.extend({
            merge: function(e, t, n) {},
            mergeWithPrev: function(e, t) {
                var n;
                return e = e.concat(), t === 0 ? (n = this.mergeSegments(e[0], e[1]), e = [ n ].concat(e.slice(2))) : (n = this.mergeSegments(e[t - 1], e[t]), 
                e = e.slice(0, t - 1).concat([ n ]).concat(e.slice(t + 1))), e;
            },
        ...
        var t = e("p"), n = e("util/array"), r = e("util/direction"), i = e("model/point"), s = e("model/polyline"), o = e("model/segment"), u = e("util/segment"), a = e("model/match"), f = e("util/math"), l = t.extend({
            $create: function(e) {
                e = e || {}, this.tolerance = e.tolerance || Math.PI / 12, this.minLength = e.minLength || 30, 
                this.closedTolerance = e.closedTolerance || 30;
            },
            match: function(e, t) {
                ...
                return n.polyline.segments = this._getSegments(r, t), n.polyline.segments = this._smoothSegments(n.polyline.segments), 
                n.polyline.segments = this._mergeShortSegments(n.polyline.segments), n.polyline.segments = this._smoothSegments(n.polyline.segments), 
                n.polyline.vertices = [ n.polyline.segments[0].start ].concat(n.polyline.segments.map(function(e) {
                    return e.end;
                })), n.polyline.closed = f.distance(n.polyline.vertices[0], n.polyline.vertices[n.polyline.vertices.length - 1]) < this.closedTolerance, 
                n.recognised = this._recognise(e.data || {}, n.polyline), n.value = n.recognised ? 1 : 0, 
                n;
            },
            _recognise: function(e, t) {
                var r = !0, i, s;
                return e.segments !== undefined && (r = e.segments === t.segments.length), r && e.directions !== undefined && (s = t.segments.map(function(e) {
                    return e.direction;
                }), i = e.directions.some(function(e) {
                    return n.compare(e, s);
                }), r = i), r && e.closed !== undefined && (r = t.closed === e.closed), r && e.test !== undefined && (r = e.test(t)), 
                r;
            },
            ...
            _smoothSegments: function(e) {
                var t = this._segmentsToPoints(e), n = this._getJointIndicies(t), r = this._getSegments(n, t);
                return r;
            },
            _segmentsToPoints: function(e) {
                var t = [];
                return e.length && (t = [ e[0].start ], e.forEach(function(e) {
                    t.push(e.end);
                })), t;
            },
            _getSegments: function(e, t) {
                var n = [], r, i, s;
                for (var u = 1; u < e.length; u++) i = t[e[u - 1]], s = t[e[u]], r = o.create(i, s), 
                n.push(r);
                return n;
            },
            _getJointIndicies: function(e) {
                var t = this._getAngles(e), n = this._anglesToJointIndicies(t);
                return n;
            },
        ...
        var t = e("algorithm/default-moses-algorithm"), n = t.extend({
            _preparePatternData: function(e) {
        ...
        var t = e("p"), n = e("model/point"), r = e("model/match"), i = t.extend({
            $create: function(e) {
            ...
            match: function(e, t) {
                var n = t.map(function(e) {
                    ...
                    return e.y;
                }), s = this._calculateMovement(n), o = this._calculateMovement(i), u = this._pointsInDirection(n, s), a = this._pointsInDirection(i, o), f = u + a, l = n.length + i.length, c = f / l, h = r.create(e, c, c > .8);
                return h.vertical = s === 0, h.horizontal = o === 0, h;
            },
            _delta: function(e) {
                var t = Math.min.apply(null, e), n = Math.max.apply(null, e);
                return n - t;
            },
            ...
            _pointsInDirection: function(e, t) {
                var n = 1;
                return t ? (e.reduce(function(e, r, i) {
                    return i === 0 ? n++ : t === 1 ? n += r > e ? 1 : r === e ? .5 : 0 : t === -1 && (n += r < e ? 1 : r === e ? .5 : 0), 
                    r;
                }.bind(this)), n) : e.length;
            }
        });
        return i;
        ...
        var t = e("algorithm/default-moses-algorithm"), n = t.extend({
            _matchingValue: function(e, n) {
                var r = e.slice();
                r.reverse();
                var i = t._matchingValue.call(this, e, n), s = t._matchingValue.call(this, r, n);
                return i > s ? i : s;
            }
        });
        return n;
        ...
        var t = e("p"), n = e("model/match"), r = t.extend({
            match: function(e, t) {
                var r, i;
                return e.patterns.forEach(function(e) {
        ...
        var t = e("p"), n = e("algorithm/pattern-collection-algorithm"), r = t.extend({
            patterns: null,
            $create: function(e) {
                this.name = e;
        ...
        var t = e("p"), n = e("model/point"), r = e("model/pattern"), i = t.extend({
        ...
        var t = e("p"), n = e("model/directions"), r = e("algorithm/default-moses-algorithm"), i = e("algorithm/polygonal-line-algorithm"), s = e("algorithm/shifted-points-moses-algorithm"), o = e("algorithm/straight-line-algorithm"), u = e("algorithm/reversed-moses-algorithm"), a = e("model/pattern"), f = e("model/pattern-collection"), l = e("model/pattern-factory"), c = t.extend({
            $create: function() {
                this.CIRCLE = f.create("Circle", this.CIRCLE_CLOCKWISE, this.CIRCLE_COUNTER_CLOCKWISE), 
                this.SQUARE = f.create("Square", this.LEFT_TOP_SQUARE, this.RIGHT_TOP_SQUARE, this.LEFT_BOTTOM_SQUARE, this.RIGHT_BOTTOM_SQUARE);
            },
            CIRCLE_CLOCKWISE: {
                value: l.fromFlatArray("Circle (clockwise)", [ 0, -100, 17, -98.5, 34, -94, 50, -86.6, 64.2, -76.6, 76.6, -64.2, 86.6, -50, 94, -34, 98.5, -17.7, 100, 0, 98.5, 17.7, 94, 34, 86.6, 50, 76.6, 64.2, 64.2, 76.6, 50, 86.6, 34, 94, 17, 98.5, 0, 100, -17, 98.5, -34, 94, -50, 86.6, -64.2, 76.6, -76.6, 64.2, -86.6, 50, -94, 34, -98.5, 17.7, -100, 0, -98.5, -17.7, -94, -34, -86.6, -50, -76.6, -64.2, -64.2, -76.6, -50, -86.6, -34, -94, -17, -98.5, 0, -100 ], s.create(.6, 10))
            },
            CIRCLE_COUNTER_CLOCKWISE: {
                value: l.fromFlatArray("Circle (counter clockwise)", [ 0, -100, -17, -98.5, -34, -94, -50, -86.6, -64.2, -76.6, -76.6, -64.2, -86.6, -50, -94, -34, -98.5, -17.7, -100, 0, -98.5, 17.7, -94, 34, -86.6, 50, -76.6, 64.2, -64.2, 76.6, -50, 86.6, -34, 94, -17, 98.5, 0, 100, 17, 98.5, 34, 94, 50, 86.6, 64.2, 76.6, 76.6, 64.2, 86.6, 50, 94, 34, 98.5, 17.7, 100, 0, 98.5, -17.7, 94, -34, 86.6, -50, 76.6, -64.2, 64.2, -76.6, 50, -86.6, 34, -94, 17, -98.5, 0, -100 ], s.create(.6, 10))
            },
            LEFT_TOP_SQUARE: {
                value: l.fromFlatArray("Square (from left top corner)", [ 0, 0, 10, 0, 20, 0, 30, 0, 40, 0, 50, 0, 60, 0, 70, 0, 80, 0, 90, 0, 90, 10, 90, 20, 90, 30, 90, 40, 90, 50, 90, 60, 90, 70, 90, 80, 90, 90, 80, 90, 70, 90, 60, 90, 50, 90, 40, 90, 30, 90, 20, 90, 10, 90, 0, 90, 0, 80, 0, 70, 0, 60, 0, 50, 0, 40, 0, 30, 0, 20, 0, 10, 0, 0 ], u.create(.7, 4))
            },
            RIGHT_TOP_SQUARE: {
                value: l.fromFlatArray("Square (from right top corner)", [ 90, 0, 90, 10, 90, 20, 90, 30, 90, 40, 90, 50, 90, 60, 90, 70, 90, 80, 90, 90, 80, 90, 70, 90, 60, 90, 50, 90, 40, 90, 30, 90, 20, 90, 10, 90, 0, 90, 0, 80, 0, 70, 0, 60, 0, 50, 0, 40, 0, 30, 0, 20, 0, 10, 0, 0, 10, 0, 20, 0, 30, 0, 40, 0, 50, 0, 60, 0, 70, 0, 80, 0, 90, 0 ], u.create(.7, 4))
            },
            LEFT_BOTTOM_SQUARE: {
                value: l.fromFlatArray("Square (from left bottom corner)", [ 0, 90, 0, 80, 0, 70, 0, 60, 0, 50, 0, 40, 0, 30, 0, 20, 0, 10, 0, 0, 10, 0, 20, 0, 30, 0, 40, 0, 50, 0, 60, 0, 70, 0, 80, 0, 90, 0, 90, 10, 90, 20, 90, 30, 90, 40, 90, 50, 90, 60, 90, 70, 90, 80, 90, 90, 80, 90, 70, 90, 60, 90, 50, 90, 40, 90, 30, 90, 20, 90, 10, 90, 0, 90 ], u.create(.7, 4))
            },
            RIGHT_BOTTOM_SQUARE: {
                value: l.fromFlatArray("Square (from right bottom corner)", [ 90, 90, 80, 90, 70, 90, 60, 90, 50, 90, 40, 90, 30, 90, 20, 90, 10, 90, 0, 90, 0, 80, 0, 70, 0, 60, 0, 50, 0, 40, 0, 30, 0, 20, 0, 10, 0, 0, 10, 0, 20, 0, 30, 0, 40, 0, 50, 0, 60, 0, 70, 0, 80, 0, 90, 0, 90, 10, 90, 20, 90, 30, 90, 40, 90, 50, 90, 60, 90, 70, 90, 80, 90, 90 ], u.create(.7, 4))
            },
            V: {
                value: l.fromFlatArray("V", [ -50, -100, -45, -90, -40, -80, -35, -70, -30, -60, -25, -50, -20, -40, -15, -30, -10, -20, -5, -10, 0, 0, 5, -10, 10, -20, 15, -30, 20, -40, 25, -50, 30, -60, 35, -70, 40, -80, 45, -90, 50, -100 ], r.create(.6, 4))
            },
            DASH: {
                value: l.fromFlatArray("Chevron", [ -50, 100, -45, 90, -40, 80, -35, 70, -30, 60, -25, 50, -20, 40, -15, 30, -10, 20, -5, 10, 0, 0, 5, 10, 10, 20, 15, 30, 20, 40, 25, 50, 30, 60, 35, 70, 40, 80, 45, 90, 50, 100 ], r.create(.6, 4))
            },
            SEVEN: {
                value: l.fromFlatArray("Seven", [ 0, 0, 10, 0, 20, 0, 30, 0, 40, 0, 50, 0, 60, 0, 70, 0, 80, 0, 90, 0, 100, 0, 90, 10, 80, 20, 70, 30, 60, 40, 50, 50, 40, 60, 30, 70, 20, 80, 10, 90, 0, 100 ], r.create(.7, 2))
            },
            Z: {
                value: l.fromFlatArray("Z", [ 0, 0, 10, 0, 20, 0, 30, 0, 40, 0, 50, 0, 60, 0, 70, 0, 80, 0, 90, 0, 100, 0, 90, 10, 80, 20, 70, 30, 60, 40, 50, 50, 40, 60, 30, 70, 20, 80, 10, 90, 0, 100, 10, 100, 20, 100, 30, 100, 40, 100, 50, 100, 60, 100, 70, 100, 80, 100, 90, 100 ], r.create(.65, 4))
            },
            LINE_UP_DOWN: {
                value: l.fromFlatArray("Up-down", [ 0, 0, 0, 10, 0, 20, 0, 30, 0, 40, 0, 50, 0, 60, 0, 70, 0, 80, 0, 90, 0, 100 ], r.create(.7, 2))
            },
            LINE_DOWN_UP: {
                value: l.fromFlatArray("Down-up", [ 0, 0, 0, -10, 0, -20, 0, -30, 0, -40, 0, -50, 0, -60, 0, -70, 0, -80, 0, -90, 0, -100 ], r.create(.7, 2))
            },
            LINE_LEFT_RIGHT: {
                value: l.fromFlatArray("Left-right", [ 0, 0, 10, 0, 20, 0, 30, 0, 40, 0, 50, 0, 60, 0, 70, 0, 80, 0, 90, 0, 100, 0 ], r.create(.7, 2))
            },
            LINE_RIGHT_LEFT: {
                value: l.fromFlatArray("Right-left", [ 0, 0, -10, 0, -20, 0, -30, 0, -40, 0, -50, 0, -60, 0, -70, 0, -80, 0, -90, 0, -100, 0 ], r.create(.7, 2))
            },
            STRAIGHT_LINE: {
                value: a.create("Straight line", [], o.create())
            },
            POLYGONAL: {
                value: {
                    LINE: a.create("Straight line", {
                        segments: 1
                    }, i.create()),
                    Z: a.create("Z", {
                        segments: 3,
                        closed: !1,
                        directions: [ [ n.RIGHT, n.LEFT_DOWN, n.RIGHT ] ]
                    }, i.create()),
                    TRIANGLE: a.create("Triangle", {
                        segments: 3,
                        closed: !0
                    }, i.create()),
                    TWO_LINES: a.create("Two lines", {
                        segments: 2,
                        closed: !1
                    }, i.create()),
                    DOUBLE_LINE: a.create("Double line", {
                        segments: 2,
                        closed: !0
                    }, i.create()),
                    RECTANGLE: a.create("Rectangle", {
                        segments: 4,
                        closed: !0,
                        directions: [ [ n.RIGHT, n.DOWN, n.LEFT, n.UP ], [ n.DOWN, n.LEFT, n.UP, n.RIGHT ], [ n.LEFT, n.UP, n.RIGHT, n.DOWN ], [ n.UP, n.RIGHT, n.DOWN, n.LEFT ], [ n.DOWN, n.RIGHT, n.UP, n.LEFT ], [ n.RIGHT, n.UP, n.LEFT, n.DOWN ], [ n.UP, n.LEFT, n.DOWN, n.RIGHT ], [ n.LEFT, n.DOWN, n.RIGHT, n.UP ] ]
                    }, i.create())
                }
            }
        });
        ...
        var t = e("p"), n = t.extend([ t.Dispatcher ], {
            _data: null,
            getData: function() {
                return this._data;
            },
        ...
        var t = e("sampler/sampler"), n = e("model/point"), r = t.extend({
            _element: null,
            _pointerId: null,
            $create: function(e) {
                this._element = e;
            ...
            activate: function() {
                this.__startScreening = this._startScreening.bind(this), this._element.addEventListener("pointerdown", this.__startScreening), 
            ...
            _startScreening: function(e) {
                this._pointerId || (this._pointerId = e.pointerId, this._data = [], this._addMousePosition(e), 
                this.__continueScreening = this._continueScreening.bind(this), this._element.addEventListener("pointermove", this.__continueScreening), 
                this.__endScreening = this._endScreening.bind(this), this._element.addEventListener("pointerup", this.__endScreening), 
                this._dispatchStarted());
            },
            _deactivateScreening: function() {
                this._element.removeEventListener("pointermove", this.__continueScreening), this._element.removeEventListener("pointerup", this.__endScreening), 
        ...
        var t = e("sampler/dom-sampler"), n = e("util/math"), r = t.extend({
            distance: null,
            $create: function(e, t) {
                this.distance = t;
            },
            _continueScreening: function(e) {
                var r = this.getLastPosition(), i = this._mousePosition(e);
        ...
        var t = e("sampler/dom-sampler"), n = t.extend({
            interval: null,
            _timer: null,
            _lastEvent: null,
            $create: function(e, t) {
        ...
        return {
            ...
            algorithm: {
                DefaultMosesAlgorithm: g,
                MosesFit: y,
                PatternCollectionAlgorithm: b,
                ReversedMosesAlgorithm: w,
                PolygonalLineAlgorithm: E,
                ShiftedPointsMosesAlgorithm: S,
                StraightLineAlgorithm: x
            },
            util: {
                Array: T,
                Math: N,
